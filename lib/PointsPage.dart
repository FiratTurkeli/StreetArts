...
import 'package:istanbulsokaksanatlari/LocationSheet.dart';
        ...
        onTap: (){
          showModalBottomSheet(
            shape: const RoundedRectangleBorder(
              ...
              context: context,
              builder: (builder){
            return LocationSheet(location_uid: "2penas7ZF7gdMx8si5TQ");
      ...
      _markers.add( Marker(
        ...
        onTap: (){
          showModalBottomSheet(
              ...
              context: context,
              builder: (builder){
                return LocationSheet(location_uid: "98oI5BRTkcTynD9gtMwd");
        ...
        infoWindow: const InfoWindow(title: "Bahariye Sahnesi" , snippet: "Caferağa, General Asım Gündüz Cd. No: 64"),
          onTap: (){
            showModalBottomSheet(
                ...
                context: context,
                builder: (builder){
                  return LocationSheet(location_uid: "kFdA0hQdaGkmCWESXzvv");
      ...
      _markers.add( Marker(
          ...
          onTap: (){
            showModalBottomSheet(
                ...
                context: context,
                builder: (builder){
                  return LocationSheet(location_uid: "xIxPddmvrn5NBK61ISJ2");
