...
import 'package:istanbulsokaksanatlari/screens/event_detail_screen.dart';
              ...
              child: ListView.builder(
                ...
                primary: true,
                  ...
                  itemBuilder: (contex,index){
                    ...
                    return  InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => EventDetailScreen(etkinlik: "${upcomingList["event_uid"]}")));
                      },
                      child: Container(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                               ...
                               Column(
                                ...
                                children: <Widget>[
                                   Text("${upcomingList["artist_name"]} ${upcomingList["artist_surname"]}", style: upcomingEventStyle),
